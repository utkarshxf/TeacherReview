...
import com.orion.templete.presentation.main.screens.home.teachers_list.selected_teacher.add_review.AddReviewScreen
                    ...
                    NavHost(
                        ...
                        composable(route = Screen.SelectedBlog.route) {
                            val addScreenData =
                                navController.previousBackStackEntry
                                    ?.savedStateHandle
                                    ?.get<TeacherDTO>("data-mapped")
                            if (addScreenData != null) {
                                SelectedBlogScreen(
                                    navigateToBlogs = { navController.popBackStack() },
                                    addScreenData
                                ) { reviewsData ->
